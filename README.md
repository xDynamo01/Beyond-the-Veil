...
Explore the city and respond to reports
Investigate crime scenes and collect evidence
Follow clues and connect leads
...
Dynamic events and random encounters (planned)
Investigation System
Evidence collection and clue tracking
Case journal with objectives and notes
NPC interaction and dialogue system (planned)
Following leads through locations and witnesses
ARPG Combat & Progression
Real-time combat system
Enemy encounters across the city
Equipment system (weapons, armor, accessories)
Character upgrades and stats progression
Loot drops and item rarity system (planned)
...
City exploration foundation
Basic player controller and camera
